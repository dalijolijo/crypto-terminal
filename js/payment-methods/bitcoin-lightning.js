			...
			'en': {
				...
				'settings.apiUrl.description': 'The full URL to your LN node. Should include the protocol (e.g "https://").',
                        ...
                        'de': {
                                ...
                                'settings.apiUrl.description': 'Die vollständige URL (inklusiv des Protokolls, z.B. "https://") zu Ihrem Lightning Network Knoten.',
                                'settings.invoiceMacaroon.label': 'Rechnung Macaroon',
                                'settings.invoiceMacaroon.description': 'Wird verwendet, um Anfragen an Ihren Lightning Network Knoten zu authentifizieren. Muss eine Hexadezimal-Zahl sein.',
